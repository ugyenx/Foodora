...
const CarousalCard = (props) => {
  ...
  return (
    <section>
      ...
      <div className="bg-white rounded-3xl   shadow-[0_10px_30px_rgba(0,0,0,0.15),inset_11px_16px_78px_11px_rgba(0,0,0,0.15)]   w-64 h-60 mb-7 transition-transform duration-300 hover:-translate-y-2">
