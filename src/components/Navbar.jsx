...
const Navbar = () => {
  return (
    <nav className="flex justify-between mx-35 my-9">
      <div className="flex ">
        <h1 className="text-3xl font-bold tracking-wide">F</h1>
        <h1 className="text-3xl font-bold text-red-700 tracking-wide">OO</h1>
      ...
      <div className="flex gap-5 items-center justify-start mr-15">
        ...
        <button className="bg-red-500 text-white px-5 py-2  rounded-4xl">
          Sign Up
        </button>
      </div>
    </nav>
